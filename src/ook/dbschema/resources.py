...
if TYPE_CHECKING:
    from .authors import SqlAuthor, SqlCollaboration
...
class SqlContributor(Base):
    ...
    and contributors (authors/collaborations).
    """
    ...
    """The author ID for individual contributors."""

    collaboration_id: Mapped[int | None] = mapped_column(
        ForeignKey("collaboration.id"), nullable=True
    )
    """The collaboration ID for collaboration contributors."""
    ...
    """The author for individual contributors."""

    collaboration: Mapped[SqlCollaboration | None] = relationship(
        "SqlCollaboration"
    )
    """The collaboration for collaboration contributors."""

    __table_args__ = (
        # Ensure only one of author_id or collaboration_id is set
