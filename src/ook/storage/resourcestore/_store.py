...
class ResourceStore:
    ...
    def _sql_to_domain(self, sql_resource: SqlResource) -> Resource:
        ...
        if hasattr(sql_resource, "contributors") and sql_resource.contributors:
            contributors = []
            # TODO(jonathansick): Implement full contributor conversion
            # For now, create empty list to avoid errors
        ...
        if hasattr(sql_resource, "relations") and sql_resource.relations:
            external_relations = []
            # TODO(jonathansick): Implement external relations conversion
